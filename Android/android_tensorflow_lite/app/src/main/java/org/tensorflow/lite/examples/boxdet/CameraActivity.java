...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private TextView threadsTextView,tv_confidence;
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    model_idx = intent.getIntExtra(MainActivity.EXTRA_MESSAGE,0);
          ...
          = new SeekBar.OnSeekBarChangeListener()
  {
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser)
    {
      ...
      confidence = (float)progress/100;
      String str = String.valueOf(progress) + "%";
      tv_confidence.setText(str);
    }
  };

  private float confidence;
  protected float get_confidence(){ return confidence;}
  private int model_idx;
  protected int model_file_idx() { return model_idx; }
