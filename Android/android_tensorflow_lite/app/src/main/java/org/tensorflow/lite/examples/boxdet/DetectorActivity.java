...
import org.tensorflow.lite.examples.boxdet.customview.OverlayView.DrawCallback;
import org.tensorflow.lite.examples.boxdet.env.BorderedText;
...
//    private static final String TF_OD_API_LABELS_FILE = "file:///android_asset/coco.txt";
    ...
    private static final float MINIMUM_CONFIDENCE_TF_OD_API = 0.4f/*0.5f*//*0.66f*/;
    ...
    public void onPreviewSizeChosen(final Size size, final int rotation) {
        ...
        int image_size = Integer.valueOf(size_str[idx]);
        int cropSize = image_size;

        try {
            Log.e("Awei","-----file Name:" +  model_name[idx] + "size:" + image_size);
            detector =
                    YoloV4Classifier.create(
                            getAssets(),
                            model_name[idx],//TF_OD_API_MODEL_FILE,
                            label_str[idx], //TF_OD_API_LABELS_FILE
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        float minimumConfidence = get_confidence();//MINIMUM_CONFIDENCE_TF_OD_API;
                        switch (MODE) {
                            case TF_OD_API:
                                minimumConfidence = get_confidence();//MINIMUM_CONFIDENCE_TF_OD_API;
                                break;
                        }
